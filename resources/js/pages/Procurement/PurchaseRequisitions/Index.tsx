...
export default function Index({ requisitions }: Props) {
    ...
    const columns: Column<PurchaseRequisition>[] = [
        { header: trans('No. Dokumen'), key: 'doc_number', sortable: true },
        { header: trans('Pembuat'), accessorKey: 'requester.name', sortable: true },
        { header: trans('Tipe'), accessorKey: 'procurement_type.name', sortable: true },
